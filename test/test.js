...
casper.test.begin("when using Chrome on Windows", 5, function(test) {
...
casper.test.begin("when using Chrome on Mac", 5, function(test) {
...
casper.test.begin("when using Chrome on an Android device", 5, function(test) {
...
casper.test.begin("when using Chrome on Linux", 5, function(test) {
...
casper.test.begin("when using Firefox on Windows", 5, function(test) {
...
casper.test.begin("when using Firefox on Mac", 5, function(test) {
...
casper.test.begin("when using Firefox on Linux", 5, function(test) {
...
casper.test.begin("when using Safari on Mac", 5, function(test) {
...
casper.test.begin("when using Safari on iPad", 5, function(test) {
...
casper.test.begin("when using Safari on iPhone", 5, function(test) {
...
casper.test.begin("when using IE9", 5, function(test) {
...
casper.test.begin("when using IE10", 5, function(test) {
...
casper.test.begin("when using IE11", 5, function(test) {
...
casper.test.begin("when using IE10 on a Windows Phone", 5, function(test) {
...
casper.test.begin("when using Opera 15+ on Windows", 5, function(test) {
...
casper.test.begin("when using Opera 15+ on Mac", 5, function(test) {
...
casper.test.begin("when using Opera 10 on Windows", 5, function(test) {
...
casper.test.begin("when using Opera 10 on Mac", 5, function(test) {
